<!doctype html>
<!-- Static dashboard design (no functionality) -->
<html lang="en">
<head>
  <meta charset="utf-8">
  <meta name="viewport" content="width=device-width, initial-scale=1">
  <title>Admin Dashboard — DTI Aurora Price Monitoring</title>
  <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.2/dist/css/bootstrap.min.css" rel="stylesheet">    
  <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.5.0/css/all.min.css">
  <style>
    /* ================================================
       DTI PHILIPPINES COLOR THEME
       ================================================ */
    :root {
      --dti-blue: #0055a5;       /* Official DTI Blue */
      --dti-red: #ef4123;        /* Official DTI Red */
      --dti-yellow: #ffd100;     /* Official DTI Yellow */
      --dti-light-blue: #e6f0ff; /* Light blue for backgrounds */
      --dti-dark: #003366;       /* Dark blue for text */
      --dti-light: #f8fafc;      /* Light background */
      --dti-gray: #6b7280;       /* Neutral gray */
      --dti-border: #d1d5db;     /* Border color */
      --dti-white: #ffffff;
      --dti-success: #10b981;
      --dti-warning: #f59e0b;
      --dti-danger: #ef4444;
...
<body>
  ...
  <script>
    (function(){
      ...
      if (sidebarToggle) {
        sidebarToggle.addEventListener('click', () => {
          ...
          sidebarToggle.setAttribute('aria-label', 
            isHidden ? 'Show navigation menu' : 'Hide navigation menu');
      ...
      // Add loading animation for demo purposes
      setTimeout(() => {
